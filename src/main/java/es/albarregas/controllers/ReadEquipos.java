...
@WebServlet(name = "ReadEquipos", urlPatterns = {"/readEquipos"})
public class ReadEquipos extends HttpServlet {
    ...
    protected void procesarPeticion(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/JSPX/readEquipos.jspx").forward(request, response);
    }
